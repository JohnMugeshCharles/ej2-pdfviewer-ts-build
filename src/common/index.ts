...
function renderLeftPaneComponents(): void {
    ...
    let initialComponent = location.hash.split('/')[2] || 'pdfviewer';
        ...
        for (let subNode of samples) {
            ...
            crossRoads.addRoute(urlString, () => {
                ...
                if (control === 'spreadsheet' || control === 'pdfviewer') {
                    ...
                    const components = { 'spreadsheet': 'spreadsheet-editor', 'pdfviewer': 'pdf-viewer', 'document-editor': 'docx-editor' };
                    const canonicalUrl = `https://document.syncfusion.com/demos/${components[control]}/javascript/#/${themeTag}/${controlTag}/${sampleTag}`;
