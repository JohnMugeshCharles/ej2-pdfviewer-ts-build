...
(window as any).default = (): void => {
    ...
    var formFieldToolbar = new Tool({
        items: [
         ...
         { id: 'formField_checkbox', prefixIcon: 'e-icons e-check-box', click: checkBox.bind(this), tooltipText: 'Checkbox', align: 'Center' },
    ...
    bookmarkPopup = new Dialog({
        ...
        buttons: [{
            buttonModel: {},
        }], position: { X: 'left', Y: 'top' }, cssClass: 'e-bookmark-popup', visible: false, beforeClose: (): void => {
            isBookmarkOpen = false;
         }
    });
    ...
    textSearchPopup = new Dialog({
        ...
        buttons: [{
            buttonModel: {},
        }], position: { X: 'right', Y: 'top' }, cssClass: 'e-text-search-popup', visible: false,
    });
